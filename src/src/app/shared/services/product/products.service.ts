...
export class ProductsService {
  ...
  fetchProducts(pagination: Pagination, filtering: IProductsFiltering, sortings: string[]): Observable<IProductsInfo>{
    ...
    return this.httpClient.get<IProductsInfo>(`${this.baseUrl}`, {params: httpParams})
  }

  fetchProduct(id: string): Observable<IProduct>{
    return this.httpClient.get<IProduct>(`${this.baseUrl}id/${id}`);
  }
}
